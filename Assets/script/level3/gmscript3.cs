...
{	
	 ...
	 public void completeword()
    {
		...
		{
			switch(currentword)
				{case "PRIG":innerlevel("E","A","T","H");
				
								break;
				case "HEAT":innerlevel("I","S","T","L");
						break;
				case "SILT":innerlevel("E","A","D","L");
						break;
				case "DALE":innerlevel("A","E","D","M");
						break;
				case "MEAD":innerlevel("E","A","N","M");
						break;
				case "MANE":StartCoroutine(nextleveltimer());
						break;
				default:			
