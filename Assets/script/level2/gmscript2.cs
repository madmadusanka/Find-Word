...
{	
	 ...
	 public void completeword()
    {
		...
		{
			switch(currentword)
				{case "PAT":innerlevel("R","T","O","A");
				
								break;
				case "OAR":innerlevel("E","A","S","T");
						break;
				case "SAT":innerlevel("E","S","W","T");
						break;
				case "SEW":innerlevel("I","S","T","B");
						break;
				case "SIB":innerlevel("E","Y","H","T");
						break;
				case "THY":StartCoroutine(nextleveltimer());
						break;
				default:			
