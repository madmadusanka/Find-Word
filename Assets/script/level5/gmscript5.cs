...
{	
    ...
    void Start()
    {
		PlayerPrefs.SetInt("currentLevel",5);//must change in level
	...
	else if(lettercount==2)
	{
		...
		wordbox5.GetComponent<TextMesh>().text=currentletter;	
	}
	//must add in level
    }
	 public void completeword()
    {
		...
		{
			switch(currentword)
				{case "AMIDE":innerlevel("A","E","R","Z","B");
				
						break;
				case "BRAZE":innerlevel("E","A","T","L","R");//must change in level
						break;
				case "ALTER":innerlevel("E","E","S","T","R");
						break;
				case "TERSE":innerlevel("A","E","S","K","T");
						break;
				case "STEAK":innerlevel("E","A","B","D","R");
						break;
				case "DEBAR":StartCoroutine(nextleveltimer());
						break;
				default:			
    ...
    {	
		...
		wordbox5.GetComponent<TextMesh>().text=null;
